"""GenericParser 0.44.6.2 bootstrap with controller-side recovery metadata.

The proven 0.44.4 search path remains unchanged. Recovery after a terminal
503/1101 chain is implemented exclusively in the browser controller: the
saved search state is retained, the worker is probed after a quiet period and
one automatic resume attempt is allowed.
"""
...
from .build_identity_v04462 import (
    API_CONTRACT,
    BOOTSTRAP_MODULE,
    BUILD_ID,
    ENTRYPOINT,
