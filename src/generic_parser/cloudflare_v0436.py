"""GenericParser 0.43.6 stable bootstrap with robust title extraction."""
from __future__ import annotations
import importlib
from typing import Any
from fastapi import FastAPI, Request
from fastapi.responses import JSONResponse
from .build_identity_v0436 import API_CONTRACT, BOOTSTRAP_MODULE, BUILD_ID, ENTRYPOINT, SEARCH_MODULE, VERSION, WORKER_UNIT
...
async def version() -> JSONResponse:
    return respond(200, {"status": "ok", **identity(), "search_ready": True, "service_loaded": _service is not None, "free_plan_mode": True, "packet_size": 7, "pause_ms": 5000, "pagination_strategy": "source_html_weiter_link", "coverage_evidence": True, "coverage_schema": "robust-title-v1", "robust_title_fallback": True, "title_order": ["h2", "anzeige_link_text", "aria_label", "title_attribute", "image_alt"], "last_import_error": _last_error})
...
async def search(request: Request) -> JSONResponse:
    try:
        ...
        return failure(request, "Arbeitspaket konnte nicht verarbeitet werden.", "robust_title_flow", exc)
