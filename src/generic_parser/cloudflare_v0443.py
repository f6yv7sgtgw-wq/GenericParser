"""GenericParser 0.44.3 bootstrap on the proven 0.44.2 reference flow."""
from __future__ import annotations
import importlib
from typing import Any
from fastapi import FastAPI, Request
from fastapi.responses import JSONResponse
from .build_identity_v0443 import API_CONTRACT, BOOTSTRAP_MODULE, BUILD_ID, ENTRYPOINT, SEARCH_MODULE, VERSION, WORKER_UNIT
...
async def version() -> JSONResponse:
    return respond(200, {"status": "ok", **identity(), "search_ready": True, "service_loaded": _service is not None, "packet_size": 7, "pause_ms": 5000, "pagination_strategy": "source_html_weiter_link", "reference_version": "0.44.2", "traffic_light_model": "v1", "runtime_card_patch": False, "last_import_error": _last_error})
...
async def search(request: Request) -> JSONResponse:
    try:
        ...
        return failure(request, "Arbeitspaket konnte nicht verarbeitet werden.", "traffic_light_flow", exc)
