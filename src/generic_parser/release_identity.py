...
WORKER_UNIT = "stable-paid+runtime-bridge+three-sources+product-classification+result-filters+explicit-browser-favorites+signed-ebay-deletion-endpoint+truthful-stop-status+fail-open-browser-startup+web-ui-162+module-v1+module-v2"
FUNCTIONAL_REFERENCE = "0.44.4"
OPERATIONAL_REFERENCE = "0.44.6.5"
RUNTIME_REFERENCE = "0.44.6.2"
TECHNICAL_BASE = "three-source-orchestration+product-classification-v1+traffic-group-sort+browser-local-explicit-favorites+ebay-ecdsa-deletion-notifications+truthful-stop-status+fail-open-identity+responsive-web-ui-162+signed-continuations-v2"
