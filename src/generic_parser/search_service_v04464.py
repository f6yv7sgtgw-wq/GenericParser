"""GenericParser 0.44.6.4 wrapper around the unchanged 0.44.4 core.

The release changes only the Cloudflare bootstrap and recovery readiness path.
Search, extraction, pagination, matching and traffic-light evaluation remain
fully delegated to ``search_service_v0444``.
"""
