"""Cloudflare-Python-Worker entrypoint for GenericParser 0.44.6.3.

Recovery-hardening release on the proven 0.44.4 ASGI/search path. Search,
...
from generic_parser.cloudflare_v04463 import app  # noqa: E402
