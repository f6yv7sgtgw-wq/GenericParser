"""GenericParser 0.44.1 bootstrap on the proven 0.43.6.3 search flow."""
from __future__ import annotations
import importlib
from typing import Any
from fastapi import FastAPI, Request
from fastapi.responses import JSONResponse
from .build_identity_v0441 import API_CONTRACT, BOOTSTRAP_MODULE, BUILD_ID, ENTRYPOINT, SEARCH_MODULE, VERSION, WORKER_UNIT
...
async def version() -> JSONResponse:
    return respond(200, {"status": "ok", **identity(), "search_ready": True, "service_loaded": _service is not None, "free_plan_mode": True, "packet_size": 7, "pause_ms": 5000, "pagination_strategy": "source_html_weiter_link", "stable_base": "0.43.6.3", "semantic_result_cards": True, "optimized_result_cards": True, "last_import_error": _last_error})
...
async def search(request: Request) -> JSONResponse:
    try:
        ...
        return failure(request, "Arbeitspaket konnte nicht verarbeitet werden.", "stable_0441_flow", exc)
