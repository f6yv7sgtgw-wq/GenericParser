"""GenericParser 0.44.6.1 bootstrap with diagnostic-only corrections.

The proven 0.44.4 search path remains unchanged. This release only exposes
explicit reference-mode diagnostics so the event log does not require the
experimental 0.44.5.x coverage schema.
"""
