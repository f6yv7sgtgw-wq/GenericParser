(() => {
  ...
  const sourceUrl = new URL('./controller-0411.js?v=0.445-stable-source', location.href);
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      Function(`${source}\n//# sourceURL=controller-0445-runtime.js`)();
      ...
      if (state) { state.className = 'compact-status done'; state.innerHTML = '<strong>Bereit</strong><span>Direkter Free-Worker ohne ASGI/FastAPI aktiv</span>'; }
      ...
      window.GP_CONTROLLER_IDENTITY = {version:I.version,buildId:I.buildId,apiContract:I.apiContract,module:'controller-0445.js',functionalReference:'0.44.4',runtimeModel:'direct-worker-stdlib-v1'};
