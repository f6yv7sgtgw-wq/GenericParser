(() => {
  ...
  const sourceUrl = new URL('./controller-0411.js?v=0.4463-reference-source', location.href);
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      Function(`${source}\n//# sourceURL=controller-04463-runtime.js`)();
      ...
      if (state) { state.className = 'compact-status done'; state.innerHTML = '<strong>Bereit</strong><span>Referenz 0.44.4 · Recovery-Hardening aktiv</span>'; }
      ...
      window.GP_CONTROLLER_IDENTITY = {version:I.version,buildId:I.buildId,apiContract:I.apiContract,module:'controller-04463.js',referenceVersion:'0.44.4',searchCoreChanged:false,autoResume:true,maxAutoResumes:2,recoveryProbe:true};
