(() => {
  ...
  const sourceUrl = new URL('./controller-0411.js?v=0.442-stable-source', location.href);
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      Function(`${source}\n//# sourceURL=controller-0442-runtime.js`)();
      ...
      if (state) { state.className = 'compact-status done'; state.innerHTML = '<strong>Bereit</strong><span>Technischer Suchfluss aus 0.43.6.3 aktiv</span>'; }
      ...
      window.GP_CONTROLLER_IDENTITY = {version:I.version,buildId:I.buildId,apiContract:I.apiContract,module:'controller-0442.js',technicalBase:'0.43.6.3'};
