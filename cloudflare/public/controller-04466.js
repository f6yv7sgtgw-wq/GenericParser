(() => {
  ...
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      if (state) { state.className = 'compact-status done'; state.innerHTML = '<strong>Bereit</strong><span>Testversion · 90 Sekunden Pause nach 120 Treffern</span>'; }
      ...
      window.GP_CONTROLLER_IDENTITY = {version:I.version,buildId:I.buildId,apiContract:I.apiContract,module:'controller-04466.js',referenceVersion:'0.44.4',operationalReference:'0.44.6.5',runtimeReference:'0.44.6.2',searchCoreChanged:false,autoResume:true,testCooldown:false};
