(() => {
  ...
  const sourceUrl = new URL('./controller-0411.js?v=0.4466b3-reference-source', location.href);
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      // Identical controller flow to the stable 0.44.6.5 reference. The
      // cooldown experiment is isolated in cooldown-04466.js and can never
      // block this controller from starting.
      Function(`${source}\n//# sourceURL=controller-04466-build3-runtime.js`)();
      ...
      if (state) { state.className = 'compact-status done'; state.innerHTML = '<strong>Bereit</strong><span>0.44.6.5-Suche aktiv · Testpause bei 120, 240, 360 … Treffern</span>'; }
