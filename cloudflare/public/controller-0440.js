(() => {
  ...
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      if (state) { state.className = 'compact-status done'; state.innerHTML = '<strong>Bereit</strong><span>Optimierte Trefferkarten aktiv</span>'; }
      ...
      window.GP_CONTROLLER_IDENTITY = {version:I.version,buildId:I.buildId,apiContract:I.apiContract,module:'controller-0440.js'};
