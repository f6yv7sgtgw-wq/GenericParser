(() => {
  ...
  const sourceUrl = new URL('./controller-0411.js?v=0.4465-reference-source', location.href);
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      Function(`${source}\n//# sourceURL=controller-04465-runtime.js`)();
      ...
      if (state) { state.className = 'compact-status done'; state.innerHTML = '<strong>Bereit</strong><span>Sauberer Rollback auf 0.44.6.2 · Referenzkern 0.44.4</span>'; }
      ...
      window.GP_CONTROLLER_IDENTITY = {version:I.version,buildId:I.buildId,apiContract:I.apiContract,module:'controller-04465.js',referenceVersion:'0.44.4',operationalReference:'0.44.6.2',searchCoreChanged:false,autoResume:true,cleanRollback:true};
