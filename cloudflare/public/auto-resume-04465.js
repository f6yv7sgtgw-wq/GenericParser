(() => {
  ...
  const sourceUrl = new URL('./auto-resume-04462.js?v=0.4465-clean-rollback-source', location.href);
  fetch(sourceUrl, {cache:'no-store'})
    ...
    .then(source => {
      ...
      const to = "const RECOVERY_KEY = 'generic-parser-auto-resume-04465';";
      if (!source.includes(from)) throw new Error('0.44.6.2 recovery key fragment missing');
      source = source.replace(from, to);
      Function(`${source}\n//# sourceURL=auto-resume-04465-runtime.js`)();
    })
    .catch(error => {
