(() => {
  'use strict';
  const SOURCE='./controller-0411.js?v=0.422-source';
  const replacements=[
    ["const VERSION = '0.41.1';","const VERSION = '0.42.2';"],
    ["const BUILD_ID = 'gp-0411-20260802-1';","const BUILD_ID = 'gp-0422-20260802-1';"],
    ["const LOG_KEY = 'generic-parser-eventlog-0411';","const LOG_KEY = 'generic-parser-eventlog-0422';"]
  ];
  window.GP_CONTROLLER_READY=fetch(SOURCE,{cache:'no-store'}).then(r=>{if(!r.ok)throw new Error(`Controller-Quelle HTTP ${r.status}`);return r.text();}).then(source=>{
    ...
    Function(`${source}\n//# sourceURL=controller-0422-runtime.js`)();
    window.GP_CONTROLLER_VERSION='0.42.2';
    window.dispatchEvent(new CustomEvent('gp-controller-ready',{detail:{version:'0.42.2',buildId:'gp-0422-20260802-1'}}));
    return true;
