(() => {
  ...
  const sourceUrl = new URL('./controller-0411.js?v=0.4362-stable-source', location.href);
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      Function(`${source}\n//# sourceURL=controller-04362-runtime.js`)();

      const controlledFetch = window.fetch;
      window.fetch = async function compactUiFetch(input, init = {}) {
      ...
      if (state) {
        ...
        state.innerHTML = '<strong>Bereit</strong><span>Suche kann gestartet werden</span>';
      }
      ...
      window.GP_CONTROLLER_IDENTITY = {version: I.version, buildId: I.buildId, apiContract: I.apiContract, module: 'controller-04362.js'};
