(() => {
  ...
  const sourceUrl = new URL('./controller-0411.js?v=0.450-reference-source', location.href);
  fetch(sourceUrl, {cache: 'no-store'})
    ...
    .then(source => {
      ...
      Function(`${source}\n//# sourceURL=controller-0450-runtime.js`)();
      ...
      if (state) { state.className = 'compact-status done'; state.innerHTML = '<strong>Bereit</strong><span>Modulvertrag v1 · Suche unverändert aus 0.44.6.5</span>'; }
